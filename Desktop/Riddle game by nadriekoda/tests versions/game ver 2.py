...
correct_sound = pygame.mixer.Sound("Desktop/jump.wav")  # reuse if you want
...
# ---------- FUNCTIONS ----------
def reset_game():
    global lives, enemies, current_riddle, start_time
        ...
        # ----- PLAYING -----
            ...
            if event.type == ENEMY_EVENT and len(enemies) < 3:
                rect = enemy_img.get_rect(
                    midbottom=(random.randint(-150, -50), GROUND_LEVEL)
                )
                enemies.append(rect)
